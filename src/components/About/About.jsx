  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-900">
        About <span className="text-gray-400">DreamLoom</span>
        <span className="text-gray-700">Realty</span>
      </h1>
      <p className="mb-4 text-slate-700">
        As the largest platform connecting property buyers and sellers,
        DreamLoomReality boasts over 2 crore monthly visitors and 15 lakh active
        property listings. With over 17 years of experience, Magicbricks has
        evolved into a comprehensive service provider, offering home loans,
        interiors and expert advice.
      </p>
      <p className="mb-4 text-slate-700">
        DreamLoomReality also offers extensive research-based knowledge and
        insight-driven platforms like MBTV, India&apos;s leading online real
        estate YouTube channel, along with proprietary tools providing home
        buyers with price trends, forecasts and locality reviews.
      </p>
      <p className="mb-4 text-slate-700">
